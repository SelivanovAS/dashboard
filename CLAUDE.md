...
| `update_active_cases` (обход карточек активных дел) | [scripts/court_monitor/runs.py:474](scripts/court_monitor/runs.py:474) |
| `main_json` (оркестрация полного прогона) | [scripts/court_monitor/runs.py:1738](scripts/court_monitor/runs.py:1738) |

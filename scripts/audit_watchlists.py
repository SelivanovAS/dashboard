...
отчёт и руками чистит watchlist через админку (кнопка «📋 Ред. watchlist»).
...
ACTION_HINT = {
    ...
    "material_m_prefix": "🆕 Материал (М-). Дело получило номер 2-XXX/YYYY, "
                        "watchlist не обновился. Этап 3 плана: научить парсер "
                        "сохранять material_number как алиас.",

...
# (мотивировка +5..30 дн → вступление в силу +30 дн → выдача ИЛ: реальный лист
...
BANK_WRIT_CHECK_DAYS = 7        # решённый иск банка: опрос карточки раз в 7 дн
                                ...
                                # там штучные).
BANK_APPEAL_TERM_DAYS = 30      # срок на апел. обжалование (ст. 321 ГПК) — для
                                # расчётной даты вступления в силу (мотивировка
                                # + 30 дн, сдвиг на ближайший рабочий день).

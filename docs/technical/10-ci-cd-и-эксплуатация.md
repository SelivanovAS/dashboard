...
`validate_environment` ([1052](../../scripts/court_monitor/runs.py#L1052)) проверяет
наличие ключей на старте; `check_court_available` ([1084](../../scripts/court_monitor/runs.py#L1084))

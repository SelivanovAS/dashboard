...
`validate_environment` ([1028](../../scripts/court_monitor/runs.py#L1028)) проверяет
наличие ключей на старте; `check_court_available` ([1060](../../scripts/court_monitor/runs.py#L1060))

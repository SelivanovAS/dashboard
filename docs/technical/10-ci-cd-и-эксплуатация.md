...
`validate_environment` ([553](../../scripts/court_monitor/runs.py#L553)) проверяет
наличие ключей на старте; `check_court_available` ([585](../../scripts/court_monitor/runs.py#L585))
